...
import (
	...
	"github.com/kuadrant/kcp-glbc/pkg/reconciler/migration"
...
func main() {
	...
	secretController, err := migration.NewController(&migration.ControllerConfig{
		ObjectClient:          kcpKubeClient,
		SharedInformerFactory: kcpKubeInformerFactory,
	})
	exitOnError(err, "Failed to create Secret migration controller")
